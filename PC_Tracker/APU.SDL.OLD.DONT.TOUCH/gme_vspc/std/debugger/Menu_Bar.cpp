...
{
  BaseD::tmp_profile = new BaseD::Profile; /* buffer large enough for data */
  BaseD::Profile::is_profiling = true;
  ...
  if (SDL_RWread(orig_spc_file, BaseD::tmp_profile->orig_spc_state, Snes_Spc::spc_file_size, 1) == 0)
  {
