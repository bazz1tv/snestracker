...
{\
  ...
  idx+= ((addr)%256)<<3;\
  memsurface.data[idx]=0x0;\
  memsurface.data[idx+2048]=0x0;\
  memsurface.data[idx+4]=0x00;\
  memsurface.data[idx+4+2048]=0x00;\
  memsurface.data[idx+1]=0xff;\
  memsurface.data[idx+2048+1]=0xff;\
  memsurface.data[idx+4+1]=0xff;\
  memsurface.data[idx+4+2048+1]=0xff;\
  memsurface.data[idx+2]=0x0;\
  memsurface.data[idx+2048+2]=0x0;\
  memsurface.data[idx+4+2]=0x0;\
  memsurface.data[idx+4+2048+2]=0x0;\
  } while(0)
