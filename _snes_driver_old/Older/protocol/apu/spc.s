...
.ENUM $00 ;DESC 
	...
	INVERSEPATTERNENTRYCOUNTER			db
	PATTERNLISTNUMBERSCURRENTENTRY		db
	
	TIMERSELECT			db
	TIMERVALUE			db
	TIMERCOUNTVALUE		dw ;$82 ; -$03
	BPLAYANOTE			db
	BKEYOFFNOTE			db
	FIRSTPITCHWASNOT0	db
	LOWPITCHTEMP		db
	HIGHPITCHTEMP		db
	...
	PATTERNLISTNUMBERSLENGTH	Db
	PATTERNLISTNUMBERS			Dsb 8
	
	
.ende

.equ PATTERNS			PATTERN0LEN
.equ PATTERN0PTRLO		PATTERN0PTR
.equ PATTERN0PTRHI		PATTERN0PTR+1
.equ PATTERN1PTRLO		PATTERN1PTR
.equ PATTERN1PTRHI		PATTERN1PTR+1
