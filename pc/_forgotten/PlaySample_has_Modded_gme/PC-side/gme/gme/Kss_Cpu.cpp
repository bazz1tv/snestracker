...
//////////////////////////////////////// ED prefix
	...
	case 0xED:
		...
		default:
			ddprintf( "Opcode $ED $%02X not supported\n", data );
			warning = true;
			goto loop;
		}
		assert( false );
...
//////////////////////////////////////// DD/FD prefix
	...
	// DD/FD CB prefix
		case 0xCB: {
			...
			default:
				ddprintf( "Opcode $%02X $CB $%02X not supported\n", opcode, data2 );
				warning = true;
				goto loop;
			}
			assert( false );
	...
	// Misc
		...
		default:
			ddprintf( "Unnecessary DD/FD prefix encountered\n" );
			warning = true;
			pc--;
			goto loop;
		}
	...
	ddprintf( "Unhandled main opcode: $%02X\n", opcode );
	assert( false );
