...
void Sample_Panel::clear_all_rows(Text_Edit_Rect *ters, SDL_Surface *screen)
{
...
void Sample_Panel::clear_row(Text_Edit_Rect *ters, int row, SDL_Surface *screen)
{
...
void Sample_Panel::draw(SDL_Surface *screen/*=::render->screen*/)
{
  ...
  clear_all_rows(sample_names, ::render->screen);
